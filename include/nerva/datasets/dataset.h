                 ...
                 )
{
  ...
  Xtrain = eigen::extract_matrix<scalar>(data, Xtrain_key).transpose();
  Xtest = eigen::extract_matrix<scalar>(data, Xtest_key).transpose();
  auto Ttrain_ = eigen::extract_column_vector<long>(data, Ttrain_key);
  auto Ttest_ = eigen::extract_column_vector<long>(data, Ttest_key);
