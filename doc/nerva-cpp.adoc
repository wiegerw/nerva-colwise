...
----
See the specification document https://wiegerw.github.io/nerva-colwise/pdf/nerva-library-specifications.pdf[Nerva library specifications] for an overview of how these matrix operations are used.
